"""
Django settings for sabz_social project.
...
SECRET_KEY = 'django-insecure-%-&yz9ewaz&w5@6m^=6_#gicc(d^%&ow6#f=5n=b#e3qf=uml8'
...
WSGI_APPLICATION = 'sabz_social.wsgi.application'
